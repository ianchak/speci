# Refactor Analysis Subagent - Iteration 8: Performance Patterns

MISSION: Analyze performance patterns for code quality issues
...
- Large file I/O patterns

EDIT the plan file to fill in:

- Section 1.8: Performance Patterns (replace placeholder text with your findings)
- Section 11: Analysis Log - Update the Iteration 8 row with Key Findings and Issues Found
...
FINAL REPORT FORMAT:
"Iteration 8 complete: X issues found (C critical, H high, M medium, L low). Sections modified: 1.8, 11"